...
var partial_strokes = {
	...
	h_zou			: [heng, shu, heng, shu, heng, pie, na],  /* 走 */
	...
	h_wupo			: [heng, shu, pie, dian, pie, dian, heng],  /* 巫，婆 */
	...
	h_shuang		: [heng, pie, dian, pie, dian, pie, dian, pie, dian, pie, na],  /* 爽 */
	...
	s_xian			: [shu, hengzheshu, heng, heng, heng, piezheheng, dian],  /* 县 */
	...
	p_guai			: [pie, heng, shu, shu, heng, heng, pie, shuwanhenggou],  /* 乖 */
	p_tu			: [pie, hengzhepie, shu, hengzheshu, heng, pie, shuwanhenggou, dian],  /* 兔 */
	...
	p_jiao          : [pie, hengzhepie, pie, hengzheshugou, heng, heng, shu],  /* 角 */
	...
	d_pieweiyang	: [dian, pie, heng, heng, heng, pie],  /* 差 */
	...
	z_xiaodian		: [shugou, dian, dian, dian],  /* 恭 */
...
Characters[Characters.length] = {
	char: "运",
	first: pattern_round_left_down,
	later: [d_zouzhidi, h_two, z_sigong]
}
Characters[Characters.length] = {
	char: "扶",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "返",
	first: pattern_round_left_down,
	later: [d_zouzhidi, p_fanzipang, z_you]
}
Characters[Characters.length] = {
	char: "余",
	first: pattern_ud_up_1_down_1_down_big,
...
Characters[Characters.length] = {
	char: "矿",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, d_guang]
}
Characters[Characters.length] = {
	char: "码",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, z_ma]
}
Characters[Characters.length] = {
	char: "厕",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "岩",
	first: pattern_ud_up_1_down_2,
	later: [s_shan, h_hengxiapie, s_kou]
}
Characters[Characters.length] = {
	char: "帖",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "供",
	first: pattern_lr_left_1_right_2,
	later: [p_danrenpang, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "使",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "研",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, h_kai]
}
Characters[Characters.length] = {
	char: "砖",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, h_zhuan]
}
Characters[Characters.length] = {
	char: "厘",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "砌",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, p_qi, z_dao]
}
Characters[Characters.length] = {
	char: "砍",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, p_qianzitou, p_ren]
}
Characters[Characters.length] = {
	char: "面",
	first: pattern_single,
...
Characters[Characters.length] = {
	char: "哄",
	first: pattern_lr_left_1_right_2,
	later: [s_kou, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "显",
	first: pattern_ud_up_1_down_1_down_big,
...
Characters[Characters.length] = {
	char: "适",
	first: pattern_round_left_down,
	later: [d_zouzhidi, p_thousand, s_kou]
}
Characters[Characters.length] = {
	char: "秒",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "竿",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, h_gan]
}
Characters[Characters.length] = {
	char: "段",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "逃",
	first: pattern_round_left_down,
	later: [d_zouzhidi, p_zhaozizuo, z_zhaoziyou]
}
Characters[Characters.length] = {
	char: "食",
	first: pattern_ud_up_1_down_1_down_big,
...
Characters[Characters.length] = {
	char: "勉",
	first: pattern_round_left_down,
	later: [p_weizitou, s_mianzidi, z_li]
}
Characters[Characters.length] = {
	char: "狭",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "送",
	first: pattern_round_left_down,
	later: [d_zouzhidi, d_lanzitou, h_tian]
}
Characters[Characters.length] = {
	char: "类",
	first: pattern_ud_up_1_down_1_up_big,
...
Characters[Characters.length] = {
	char: "洪",
	first: pattern_lr_left_1_right_2,
	later: [d_sandianshui, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "洒",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "挽",
	first: pattern_lr_left_1_right_2,
	later: [h_tishoupang, p_weizitou, s_mianzidi]
}
Characters[Characters.length] = {
	char: "热",
	first: pattern_ud_up_2_down_1,
...
Characters[Characters.length] = {
	char: "逗",
	first: pattern_round_left_down,
	later: [d_zouzhidi, heng, s_kou, d_qianzitou]
}
Characters[Characters.length] = {
	char: "栗",
	first: pattern_ud_up_1_down_1_down_big,
...
Characters[Characters.length] = {
	char: "础",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, z_chu]
}
Characters[Characters.length] = {
	char: "破",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, p_pizipang, z_you]
}
Characters[Characters.length] = {
	char: "原",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "笔",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, p_mao]
}
Characters[Characters.length] = {
	char: "笑",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, p_yao]
}
Characters[Characters.length] = {
	char: "笋",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, z_yin]
}
Characters[Characters.length] = {
	char: "债",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "健",
	first: pattern_lr_left_1_right_2,
	later: [p_danrenpang, z_jianzidi, z_yuming]
}
Characters[Characters.length] = {
	char: "臭",
	first: pattern_ud_up_1_down_1_up_big,
...
Characters[Characters.length] = {
	char: "疼",
	first: pattern_round_left_up,
	later: [d_bingzitou, p_zhewen, d_ld_sl]
}
Characters[Characters.length] = {
	char: "疲",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "烘",
	first: pattern_lr_left_1_right_2,
	later: [d_huo, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "烦",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "冤",
	first: pattern_ud_up_1_down_2,
	later: [d_tubaogai, p_weizitou, s_tuzidi]
}
Characters[Characters.length] = {
	char: "谅",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "通",
	first: pattern_round_left_down,
	later: [d_zouzhidi, z_yongzitou, p_yong]
}
Characters[Characters.length] = {
	char: "能",
	first: pattern_lr_left_2_right_2,
...
Characters[Characters.length] = {
	char: "晚",
	first: pattern_lr_left_1_right_2,
	later: [s_ri, p_weizitou, s_mianzidi]
}
Characters[Characters.length] = {
	char: "啄",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "笨",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, h_ben]
}
Characters[Characters.length] = {
	char: "笼",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, h_long]
}
Characters[Characters.length] = {
	char: "笛",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, s_you]
}
Characters[Characters.length] = {
	char: "符",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, p_danrenpang, h_cun]
}
Characters[Characters.length] = {
	char: "第",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, z_dizidi]
}
Characters[Characters.length] = {
	char: "敏",
	first: pattern_lr_left_2_right_1,
...
Characters[Characters.length] = {
	...
	later: [p_eight, p_ren, s_kou, p_qianzitou, p_ren]
}
Characters[Characters.length] = {
	char: "彩",
	first: pattern_lr_left_2_right_1,
...
Characters[Characters.length] = {
	char: "商",
	first: pattern_ud_up_1_down_2,
	later: [d_shangzitou, s_tongzikuang, p_eight, s_kou]
}
Characters[Characters.length] = {
	char: "族",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "剪",
	first: pattern_ud_up_2_down_1,
	later: [d_lanzitou, heng, p_yue, s_lidaopang, z_dao]
}
Characters[Characters.length] = {
	char: "兽",
	first: pattern_ud_up_middle_down,
...
Characters[Characters.length] = {
	char: "随",
	first: pattern_lr_left_1_right_2,
	later: [z_zuoerpang, d_zouzhidi, h_hengpie, p_yue]
}
Characters[Characters.length] = {
	char: "蛋",
	first: pattern_ud_up_1_down_1_down_big,
...
Characters[Characters.length] = {
	char: "散",
	first: pattern_lr_left_2_right_1,
	later: [h_caoheng, p_yue, p_fanwenpang]
}
Characters[Characters.length] = {
	char: "惹",
	first: pattern_ud_up_middle_down,
...
Characters[Characters.length] = {
	char: "硬",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, h_geng]
}
Characters[Characters.length] = {
	char: "确",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, p_zhewen, p_yong]
}
Characters[Characters.length] = {
	char: "雁",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "筐",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, h_jiangzikuang, h_wang]
}
Characters[Characters.length] = {
	char: "等",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, h_tu, h_cun]
}
Characters[Characters.length] = {
	char: "筑",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, h_gong, p_fan]
}
Characters[Characters.length] = {
	char: "策",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, h_cizizuo]
}
Characters[Characters.length] = {
	char: "筛",
	first: pattern_ud_up_2_down_2,
...
Characters[Characters.length] = {
	char: "筒",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, s_tongzikuang, heng, s_kou]
}
Characters[Characters.length] = {
	char: "答",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, p_ren, heng, s_kou]
}
Characters[Characters.length] = {
	char: "筋",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, p_yue, z_li]
}
Characters[Characters.length] = {
	char: "筝",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, p_]
}
Characters[Characters.length] = {
	char: "傲",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "馋",
	first: pattern_lr_left_1_right_2,
	later: [p_shichi, p_weizitou, s_mianzidi, d_ld_sl]
}
Characters[Characters.length] = {
	char: "装",
	first: pattern_ud_up_2_down_1,
...
Characters[Characters.length] = {
	char: "就",
	first: pattern_lr_left_1_right_1_left_big,
	later: [d_liuzitou, s_kou, z_xiao, youzishen, dian]
}
Characters[Characters.length] = {
	char: "痛",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "粪",
	first: pattern_ud_up_1_down_2,
	later: [d_mi, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "尊",
	first: pattern_ud_up_1_down_1_up_big,
...
Characters[Characters.length] = {
	char: "裕",
	first: pattern_lr_left_1_right_1_right_big,
	later: [d_buyipang, p_eight, p_ren, s_kou]
}
Characters[Characters.length] = {
	char: "裤",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "登",
	first: pattern_ud_up_many_down_many,
	later: [dengzitou, heng, s_kou, d_qianzitou]
}
Characters[Characters.length] = {
	char: "缎",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "填",
	first: pattern_lr_left_1_right_many,
	later: [h_tu, h_ten, s_juzitou, p_eight]
}
Characters[Characters.length] = {
	char: "搏",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "碍",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, s_ri, heng, h_cun]
}
Characters[Characters.length] = {
	char: "碑",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, p_beizitou, h_ten]
}
Characters[Characters.length] = {
	char: "碎",
	first: pattern_lr_left_many_right_many,
	later: [h_hengxiapie, s_kou, d_liuzitou, p_ren, p_ren, h_ten]
}
Characters[Characters.length] = {
	char: "碰",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, d_lanzitou, h_yazhou]
}
Characters[Characters.length] = {
	char: "碗",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, d_baogaitou, p_xi, z_cangzidi]
}
Characters[Characters.length] = {
	char: "碌",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, z_luzitou, z_dianshui]
}
Characters[Characters.length] = {
	char: "雷",
	first: pattern_ud_up_1_down_1_up_big,
...
Characters[Characters.length] = {
	char: "键",
	first: pattern_lr_left_1_right_2,
	later: [p_jinzipang, z_jianzidi, z_yuming]
}
Characters[Characters.length] = {
	char: "锯",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "筹",
	first: pattern_ud_up_1_down_2,
	later: [p_zhutouban, p_zhutouban, h_piefeng, h_cun]
}
Characters[Characters.length] = {
	char: "签",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, p_ren, heng, d_yingzidi]
}
Characters[Characters.length] = {
	char: "简",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, d_men, s_ri]
}
Characters[Characters.length] = {
	char: "毁",
	first: pattern_lr_left_2_right_2,
...
Characters[Characters.length] = {
	char: "腿",
	first: pattern_lr_left_1_right_2,
	later: [p_yue, d_zouzhidi, z_henziyou]
}
Characters[Characters.length] = {
	char: "触",
	first: pattern_lr_left_1_right_1_left_big,
...
Characters[Characters.length] = {
	char: "煎",
	first: pattern_ud_up_many_down_1,
	later: [d_lanzitou, heng, p_yue, s_lidaopang, d_sidiandi]
}
Characters[Characters.length] = {
	char: "塑",
	first: pattern_ud_up_2_down_1,
...
Characters[Characters.length] = {
	char: "慎",
	first: pattern_lr_left_1_right_many,
	later: [d_shuxinpang, h_ten, s_juzitou, p_eight]
}
Characters[Characters.length] = {
	char: "誉",
	first: pattern_ud_up_1_down_1_down_big,
	later: [d_yingzidi, p_eight, d_yan]
}
Characters[Characters.length] = {
	char: "塞",
	first: pattern_ud_up_middle_down,
...
Characters[Characters.length] = {
	char: "碧",
	first: pattern_ud_up_2_down_2,
	later: [h_wang, p_bai, h_hengxiapie, s_kou]
}
Characters[Characters.length] = {
	char: "璃",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "遭",
	first: pattern_round_left_down,
	later: [d_zouzhidi, h_caoczitou, s_ri]
}
Characters[Characters.length] = {
	char: "酷",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "磁",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, d_qianzitou, z_youzipang, z_youzipang]
}
Characters[Characters.length] = {
	char: "愿",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "算",
	first: pattern_ud_up_middle_down,
	later: [p_zhutouban, p_zhutouban, s_mu, h_piecao]
}
Characters[Characters.length] = {
	char: "箩",
	first: pattern_ud_up_middle_down,
	later: [p_zhutouban, p_zhutouban, s_siwuzhe, p_xi]
}
Characters[Characters.length] = {
	char: "管",
	first: pattern_ud_up_1_down_2,
	later: [p_zhutouban, p_zhutouban, d_baogaitou, s_guanzidi]
}
Characters[Characters.length] = {
	char: "僚",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "遮",
	first: pattern_round_left_down,
	later: [d_zouzhidi, d_guang, h_caoheng, d_sidiandi]
}
Characters[Characters.length] = {
	char: "腐",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "瘦",
	first: pattern_round_left_up,
	later: [d_bingzitou, p_jiu, shu, z_you]
}
Characters[Characters.length] = {
	char: "辣",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "歉",
	first: pattern_lr_left_1_right_2,
	later: [d_jian, p_qianzitou, p_ren]
}
Characters[Characters.length] = {
	char: "熄",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "凳",
	first: pattern_ud_up_middle_down,
	later: [dengzitou, heng, s_kou, d_qianzitou, p_er]
}
Characters[Characters.length] = {
	char: "骡",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "横",
	first: pattern_lr_left_1_right_many,
	later: [h_mu, h_gongzitou, s_you, p_eight]
}
Characters[Characters.length] = {
	char: "槽",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "镇",
	first: pattern_lr_left_1_right_1_right_big,
	later: [p_jinzipang, h_ten, s_juzitou, p_eight]
}
Characters[Characters.length] = {
	char: "靠",
	first: pattern_ud_up_2_down_2,
...
Characters[Characters.length] = {
	char: "箱",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, h_mu, s_mu]
}
Characters[Characters.length] = {
	char: "箭",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, d_lanzitou, heng, p_yue, s_lidaopang]
}
Characters[Characters.length] = {
	char: "篇",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, d_hu, s_bianzili]
}
Characters[Characters.length] = {
	char: "僵",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "颠",
	first: pattern_lr_left_1_right_1_left_big,
	later: [h_ten, s_juzitou, p_eight, h_ye]
}
Characters[Characters.length] = {
	char: "橘",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "餐",
	first: pattern_ud_up_many_down_many,
	later: [d_liuzitou, p_xi, z_you, p_ren, d_liang]
}
Characters[Characters.length] = {
	char: "嘴",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "篮",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, s_liangshu, p_zhutouban, s_minzidi]
}
Characters[Characters.length] = {
	char: "邀",
	first: pattern_round_left_down,
...
Characters[Characters.length] = {
	char: "磨",
	first: pattern_round_left_up,
	later: [d_guang, h_mu, h_mu, h_hengxiapie, s_kou]
}
Characters[Characters.length] = {
	char: "凝",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "戴",
	first: pattern_round_right_up,
	later: [h_zaizikuang, s_tian, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "擦",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "翼",
	first: pattern_ud_up_middle_down,
	later: [z_xi, z_xi, s_tian, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "骤",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "警",
	first: pattern_ud_up_many_down_1,
	later: [h_caozitou, p_baozitou, s_kou, p_fanwenpang, d_yan]
}
Characters[Characters.length] = {
	char: "攀",
	first: pattern_ud_up_many_down_many,
...
Characters[Characters.length] = {
	char: "籍",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, h_gengzizuo, h_gongzitou, s_ri]
}
Characters[Characters.length] = {
	char: "魔",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "拓",
	first: pattern_lr_left_1_right_2,
	later: [h_tishoupang, h_hengxiapie, s_kou]
}
Characters[Characters.length] = {
	char: "坪",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "矾",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, p_fan]
}
Characters[Characters.length] = {
	char: "奈",
	first: pattern_ud_up_1_down_2,
...
Characters[Characters.length] = {
	char: "拱",
	first: pattern_lr_left_1_right_2,
	later: [h_tishoupang, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "挟",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "砂",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, s_shao]
}
Characters[Characters.length] = {
	char: "泵",
	first: pattern_ud_up_2_down_1,
	later: [h_hengxiapie, s_kou, z_shui]
}
Characters[Characters.length] = {
	char: "砚",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, s_jian]
}
Characters[Characters.length] = {
	char: "鸥",
	first: pattern_lr_left_2_right_1,
...
Characters[Characters.length] = {
	char: "砸",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, h_jiangzikuang, s_jin]
}
Characters[Characters.length] = {
	char: "砰",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, h_ping]
}
Characters[Characters.length] = {
	char: "砾",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, p_le]
}
Characters[Characters.length] = {
	char: "殉",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "笆",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, z_ba]
}
Characters[Characters.length] = {
	char: "俺",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "娩",
	first: pattern_lr_left_1_right_2,
	later: [z_nv, p_weizitou, s_mianzidi]
}
Characters[Characters.length] = {
	char: "骏",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "硅",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, h_tu, h_tu]
}
Characters[Characters.length] = {
	char: "硕",
	first: pattern_lr_left_2_right_1,
	later: [h_hengxiapie, s_kou, h_ye]
}
Characters[Characters.length] = {
	char: "奢",
	first: pattern_ud_up_1_down_2,
...
Characters[Characters.length] = {
	char: "笙",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, p_sheng]
}
Characters[Characters.length] = {
	char: "笤",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, z_dao, s_kou]
}
Characters[Characters.length] = {
	char: "偎",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "逸",
	first: pattern_round_left_down,
	later: [d_zouzhidi, p_weizitou, s_tuzidi]
}
Characters[Characters.length] = {
	char: "凰",
	first: pattern_round_up,
...
Characters[Characters.length] = {
	char: "搀",
	first: pattern_lr_left_1_right_2,
	later: [h_tishoupang, p_weizitou, s_mianzidi, d_ld_sl]
}
Characters[Characters.length] = {
	char: "搓",
	first: pattern_lr_left_1_right_2,
	later: [h_tishoupang, d_pieweiyang, h_gong]
}
Characters[Characters.length] = {
	char: "壹",
	first: pattern_ud_up_middle_down,
...
Characters[Characters.length] = {
	char: "硝",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, s_guangzitou, p_yue]
}
Characters[Characters.length] = {
	char: "硫",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, d_chongzitou, p_liuzidi]
}
Characters[Characters.length] = {
	char: "颊",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "筏",
	first: pattern_ud_up_1_down_2,
	later: [p_zhutouban, p_zhutouban, p_danrenpang, h_ge]
}
Characters[Characters.length] = {
	char: "牍",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "逾",
	first: pattern_round_left_down,
	later: [d_zouzhidi, p_ren, heng, p_yue, s_lidaopang]
}
Characters[Characters.length] = {
	char: "腌",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "隘",
	first: pattern_lr_left_1_right_2,
	later: [z_zuoerpang, d_lanzitou, heng, p_eight, s_minzidi]
}
Characters[Characters.length] = {
	char: "媒",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "鹉",
	first: pattern_lr_left_2_right_1,
	later: [heng, h_shizikuang, s_zhi, p_niao]
}
Characters[Characters.length] = {
	char: "瑰",
	first: pattern_lr_left_1_right_1_right_big,
...
Characters[Characters.length] = {
	char: "碘",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, s_dianzitou, p_eight]
}
Characters[Characters.length] = {
	char: "硼",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, p_yue, p_yue]
}
Characters[Characters.length] = {
	char: "碉",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, p_zhouzikuang, h_tu, s_kou]
}
Characters[Characters.length] = {
	char: "辐",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "筷",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, d_shuxinpang, z_jueziyou]
}
Characters[Characters.length] = {
	char: "魁",
	first: pattern_round_left_down,
...
Characters[Characters.length] = {
	char: "痹",
	first: pattern_round_left_up,
	later: [d_bingzitou, s_tian, h_piecao]
}
Characters[Characters.length] = {
	char: "廓",
	first: pattern_round_left_up,
...
Characters[Characters.length] = {
	char: "溢",
	first: pattern_lr_left_1_right_2,
	later: [d_sandianshui, d_lanzitou, heng, p_eight, s_minzidi]
}
Characters[Characters.length] = {
	char: "溯",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "碟",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, h_shijie, h_mu]
}
Characters[Characters.length] = {
	char: "碴",
	first: pattern_lr_left_many_right_many,
	later: [h_hengxiapie, s_kou, h_mu, s_ri, heng]
}
Characters[Characters.length] = {
	char: "碱",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, h_xianzikuang, heng, s_kou]
}
Characters[Characters.length] = {
	char: "碳",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, s_shan, h_hengpie, d_huo]
}
Characters[Characters.length] = {
	char: "辕",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "雌",
	first: pattern_lr_left_2_right_1,
	later: [s_zhi, h_bizizuo, p_quezipang]
}
Characters[Characters.length] = {
	char: "墅",
	first: pattern_ud_up_2_down_1,
...
Characters[Characters.length] = {
	char: "嘁",
	first: pattern_lr_left_1_right_2,
	later: [s_kou, h_xianzikuang, s_shangzitou, z_xiao]
}
Characters[Characters.length] = {
	char: "踊",
	first: pattern_lr_left_2_right_2,
...
Characters[Characters.length] = {
	char: "嘀",
	first: pattern_lr_left_1_right_many,
	later: [s_kou, d_shangzitou, s_tongzikuang, p_eight, s_kou]
}
Characters[Characters.length] = {
	char: "幔",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "舔",
	first: pattern_lr_left_2_right_2,
	later: [p_thousand, s_kou, h_tian, d_shuxinpang]
}
Characters[Characters.length] = {
	char: "熏",
	first: pattern_ud_up_1_down_1_up_big,
...
Characters[Characters.length] = {
	char: "箍",
	first: pattern_lr_left_many_right_many,
	later: [p_zhutouban, p_zhutouban, h_tishoupang, h_jiangzikuang, s_jin]
}
Characters[Characters.length] = {
	char: "箕",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, h_qizitou, p_eight]
}
Characters[Characters.length] = {
	char: "箫",
	first: pattern_ud_up_2_down_1,
	later: [p_zhutouban, p_zhutouban, z_shu]
}
Characters[Characters.length] = {
	char: "舆",
	first: pattern_ud_up_many_down_1,
...
Characters[Characters.length] = {
	char: "褪",
	first: pattern_lr_left_1_right_2,
	later: [d_buyipang, d_zouzhidi, z_henziyou]
}
Characters[Characters.length] = {
	char: "隧",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "撰",
	first: pattern_lr_left_1_right_many,
	later: [h_tishoupang, z_si, z_si, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "鞍",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "磕",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, h_tu, z_sigong, s_minzidi]
}
Characters[Characters.length] = {
	char: "磅",
	first: pattern_lr_left_many_right_many,
	later: [h_hengxiapie, s_kou, d_shangzitou, d_tubaogai, d_fang]
}
Characters[Characters.length] = {
	char: "碾",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, z_shi, h_gongzitou, z_sangzidi]
}
Characters[Characters.length] = {
	char: "憋",
	first: pattern_ud_up_2_down_1,
...
Characters[Characters.length] = {
	char: "篓",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, d_mi, z_nv]
}
Characters[Characters.length] = {
	char: "膘",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "澄",
	first: pattern_lr_left_1_right_many,
	later: [d_sandianshui, dengzitou, hengzheshu, s_kou, d_qianzitou]
}
Characters[Characters.length] = {
	char: "憔",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "褥",
	first: pattern_lr_left_1_right_2,
	later: [d_buyipang, h_chenxing, h_cun]
}
Characters[Characters.length] = {
	char: "谴",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "橙",
	first: pattern_lr_left_1_right_many,
	later: [h_mu, dengzitou, heng, s_kou, d_qianzitou]
}
Characters[Characters.length] = {
	char: "瓢",
	first: pattern_lr_left_2_right_1,
...
Characters[Characters.length] = {
	char: "冀",
	first: pattern_ud_up_middle_down,
	later: [s_beizizuo, p_bi, s_tian, h_gongzitou, p_eight]
}
Characters[Characters.length] = {
	char: "踱",
	first: pattern_lr_left_2_right_2,
...
Characters[Characters.length] = {
	char: "螟",
	first: pattern_lr_left_1_right_many,
	later: [s_chong, d_tubaogai, s_ri, d_liuzitou, heng, p_eight]
}
Characters[Characters.length] = {
	char: "噪",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "篡",
	first: pattern_ud_up_middle_down,
	later: [p_zhutouban, p_zhutouban, s_mu, h_da, z_sigong]
}
Characters[Characters.length] = {
	char: "篷",
	first: pattern_ud_up_2_down_2,
	later: [p_zhutouban, p_zhutouban, d_zouzhidi, p_zhewen, h_feng]
}
Characters[Characters.length] = {
	char: "篙",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, d_liuzitou, s_kou, s_tongzikuang, s_kou]
}
Characters[Characters.length] = {
	char: "篱",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, d_liuzitou, p_chadian, z_xiongzikuang, s_tongzikuang, z_sigong]
}
Characters[Characters.length] = {
	char: "儒",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "礁",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, p_quezipang, d_sidiandi]
}
Characters[Characters.length] = {
	char: "磷",
	first: pattern_lr_left_2_right_2,
	later: [h_hengxiapie, s_kou, d_mi, p_xi, h_jiangyouxia]
}
Characters[Characters.length] = {
	char: "瞭",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "瞪",
	first: pattern_lr_left_1_right_many,
	later: [s_mu, dengzitou, heng, s_kou, d_qianzitou]
}
Characters[Characters.length] = {
	char: "曙",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "簇",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, d_fang, p_pieheng, p_shi]
}
Characters[Characters.length] = {
	char: "儡",
	first: pattern_lr_left_1_right_many,
...
Characters[Characters.length] = {
	char: "癌",
	first: pattern_round_left_up,
	later: [d_bingzitou, s_kou, s_kou, s_shan]
}
Characters[Characters.length] = {
	char: "懦",
	first: pattern_lr_left_1_right_2,
...
Characters[Characters.length] = {
	char: "臀",
	first: pattern_ud_up_many_down_1,
	later: [z_shi, h_gongzitou, p_eight, p_ji, z_you, p_yue]
}
...
Characters[Characters.length] = {
	char: "蘑",
	first: pattern_ud_up_1_down_many,
	later: [h_caozitou, d_guang, h_mu, h_mu, h_hengxiapie, s_kou]
}
Characters[Characters.length] = {
	char: "藻",
	first: pattern_ud_up_1_down_many,
...
Characters[Characters.length] = {
	char: "蹬",
	first: pattern_lr_left_many_right_many,
	later: [s_kou, s_zhi, dengzitou, heng, s_kou, d_qianzitou]
}
Characters[Characters.length] = {
	char: "簸",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, h_qizitou, p_eight, p_pizipang, z_you]
}
Characters[Characters.length] = {
	char: "簿",
	first: pattern_ud_up_many_down_many,
	later: [p_zhutouban, p_zhutouban, d_sandianshui, h_fudu, h_cun]
}
Characters[Characters.length] = {
	char: "蟹",
	first: pattern_ud_up_many_down_1,
